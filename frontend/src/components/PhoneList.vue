<template>
  <div class="phone-page">
    ...
    <main class="phone-list">
      ...
      <div class="grid">
        <div v-for="phone in filteredAndSortedPhones" :key="phone._id" class="phone-card">
          <router-link :to="`/phones/${phone._id}`">
  ...
  methods: {
    async fetchPhones() {
      try {
        ...
        // lấy danh sách bộ nhớ duy nhất từ JSON
